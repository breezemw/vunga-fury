...
export const WHATSAPP_PROFILE: SocialPlatformProfile = {
  destinations: {
    ...
    profilePhoto: {
      limitations: 'Profile photos are still images. This tool does not implement any image processing.',
      mediaType: 'image',
      notes: 'Profile photo is an image-only destination.',
      orientation: 'flexible',
      ...
      sourceDocumentation: 'UNKNOWN — image specification not verified; this destination is not implemented.',
      supportsImageOptimization: false,
